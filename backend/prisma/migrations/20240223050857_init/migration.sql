/*
  ...
  - You are about to drop the `EmployeeBasicDetails` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `EmployeeOfficeDetails` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `EmployeePersonalDetails` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "Employee" DROP CONSTRAINT "Employee_emp_basic_details_id_fkey";

-- DropForeignKey
ALTER TABLE "Employee" DROP CONSTRAINT "Employee_emp_office_details_id_fkey";

-- DropForeignKey
ALTER TABLE "Employee" DROP CONSTRAINT "Employee_emp_personal_details_id_fkey";
...
-- DropTable
DROP TABLE "EmployeeOfficeDetails";
