...
<select value={field.loan_name_det} name="loan_name_det"
  onChange={(e: any) => handleInputChange("loan_name_det", e.target.value, index)}
>
  <option>Festival Adv.</option>
  <option>Motor Cycle Adv.</option>
  <option>Moped Adv.</option>
</select>
                    </div> */}
                    ...
                    <InputBox
                      ...
                      onChange={(e: any) => handleInputChange("dis_treasury_name", e.target.value, index)}
