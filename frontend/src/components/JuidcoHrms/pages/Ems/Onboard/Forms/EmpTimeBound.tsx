...
> = (props) => {
  ...
  const [employeeTrainig, setEmployeeTrainig] = useState<
    EmployeeTimeBoundDetailType[]
  >([]);
  ...
  const handleRowChanges = (
    rowIndex: number,
    key: keyof typeof defaultRowValuesEmployees,
    value: string
  ) => {
    setEmployeeTrainig((prevTrainig) => {
      const updatedEmployeeTrainig = [...prevTrainig];
      updatedEmployeeTrainig[rowIndex][
        key as keyof EmployeeTimeBoundDetailType
      ] = value;
  ...
  const addDatas = () => {
    if (employeeTrainig.length < 2) {
      ...
      setEmployeeTrainig((prev: EmployeeTimeBoundDetailType[]) => [
        ...prev,
        newRow,
      ]);
    }
            ...
            <tr className="border border-zinc-400 text-secondary w-full">
                ...
                <div className="inline-flex items-center px-2 py-2">
                  <React.Fragment>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("pay_scale", e.target.value, "from")
                      }
                    ...
                    <input
                      ...
                      placeholder="Enter Increment Amount"
                      onChange={(e) =>
                        handleInputChange("pay_scale", e.target.value, "to")
                      }
              ...
              <td className="border border-zinc-400 w-[14.27%]">
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("b_after_pay", e.target.value)
                  }
                />
              </td>
              ...
              <td className="border border-zinc-400 w-[14.27%]">
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("vide_order_no", e.target.value)
                  }
                />
              </td>
              ...
              <td className="border border-zinc-400 w-[14.27%]">
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("vide_order_date", e.target.value)
                  }
                />
              </td>
            ...
            {employeeTrainig.map((rowData: any, rowIndex) => (
              <tr key={rowIndex} className="border py-2 px-4 ">
                ...
                {COLUMNS_FOR_EMP_TRNG_INFRM.map((column, colIndex) => {
                  const stateKey: any = Object.keys(defaultRowValuesEmployees)[
                    colIndex
                  ];
                  return (
                        ...
                        <input
                          ...
                          placeholder={
                            colIndex === 1
                              ...
                              : colIndex === 2
                                ? `Enter B.Pay After Increment`
                                : colIndex === 3
                                  ? `Enter Vide Order No`
                                  : colIndex === 4
                                    ? `Enter Vide Order Date`
                                    : colIndex === 5
                                      ? `Enter Remakrs`
                                      : `Enter ${column.HEADER}`
                          }
                          ...
                          onChange={(e) =>
                            handleRowChanges(rowIndex, stateKey, e.target.value)
                          }
                        />
                      )}
                    </td>
