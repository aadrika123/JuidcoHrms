                    ...
                    <div className="mb-6">
                      ...
                      <div className="relative ">
                        <Input
                          ...
                          placeholder="Type Here Reason of regularization .."
                          onChange={handleChange}
                          onBlur={handleBlur}
                    ...
                    <div className="flex items-center justify-end mt-5 gap-5">
                      ...
                      {daysDiff && daysDiff != 0 && !checkLeaveCount ? (
                        ...
                        <PrimaryButton
                          ...
                          onClick={() => {
                            if (!daysDiff) {
                              toast.error("Failed to send Regularization Request");
                            } else {
            ...
            <div className="m-5 w-full">
              ...
              <div className="flex flex-col mt-5">
                <div className="text-sm">
                  <span>Type of Regularization - {leaveData?.emp_leave_type?.name}</span>
                </div>
                <div className="text-sm">
                  <span>
                    Date of Regularization - {leaveData?.leave_from || 'From Date'} to{" "}
                    {leaveData?.leave_to || 'To Date'}
                  </span>
                </div>

                <div className="text-sm">
                  <span>Total days of Regularization - {leaveData?.total_days}</span>
                </div>
                <div className="text-sm">
