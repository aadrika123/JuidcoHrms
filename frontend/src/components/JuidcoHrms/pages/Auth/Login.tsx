            ...
            if (data) {
                ...
                if (typeof window !== "undefined") {
                    ...
                    if (data?.user_type === "Employee") {
                        ...
                        if(typeof window !== "undefined") window.location.replace("/hrms/employee/attendance-management");
                    } else if (data?.user_type === "Super Admin") {
                        dispatch(login(data)), "a";
                        if(typeof window !== "undefined") window.location.replace("/hrms/employee/attendance-management");
                    } else {
                        dispatch(login(data));
                        if(typeof window !== "undefined") window.location.replace("/hrms/ems/dashboard");
                    }
                }
            } else {
