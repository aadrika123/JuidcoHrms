        ...
        <div>
            ...
            <div className='flex items-center mb-10'>
                ...
                <div className="w-[20rem] bg-[#ddd] h-2 mx-5 rounded-2xl" >
                    <div className="rounded-2xl bg-[#007bff] h-[100%]" style={{ width: `${progress}%` }}></div>
                </div>
            ...
            {currentStep === 1 && (
            <Nominee onNext={handleNextStep} /> 
            )}
            {currentStep === 2 && (
            <Refund onNext={handleNextStep} /> 
            )}
            {currentStep === 3 && (
            <Statement onNext={handleNextStep} /> 
            )}
            {currentStep === 4 && (
            <Nomination onNext={handleNextStep} />
            )}
            {currentStep === 5 && (
            <CalculationSheet onNext={handleNextStep} />
            )}
            {currentStep === 6 && (
